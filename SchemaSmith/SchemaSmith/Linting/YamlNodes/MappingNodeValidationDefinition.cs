...
internal class MappingNodeValidationDefinition : NodeValidationDefinition
{
    internal override YamlNodeType NodeType => YamlNodeType.Mapping;

    internal Dictionary<string, NodeValidationDefinition> RequiredProperties { get; init; } = new();
